<template>
  <div id="commend">
    ...
    <div id="choose">
       ...
       <div @click="yaoqing()"><img :src="qq" alt=""><p>邀请QQ好友</p></div>
       <div @click="yaoqing()"><img :src="facetoface" alt=""><p>面对面邀请</p></div>
    </div>
    <div id="footcont">
        <div class="wleft">
            <p>累计收益</p>
